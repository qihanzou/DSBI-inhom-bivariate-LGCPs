...
R_address = "C:/Users/qihan/Desktop/hom_W1_time"
setwd(R_address)
...
scale_y_train = runif(ntrain, 0.001, 0.3)
sigma_u_1_train = runif(ntrain, 0.5, 2)
sigma_u_2_train = runif(ntrain, 0.5, 2)
scale_u_1_train = runif(ntrain, 0.001, 0.3)
scale_u_2_train = runif(ntrain, 0.001, 0.3)
...
with_progress({
  ...
  res_train = future_lapply(
    ...
    function(j) {
      ...
      params = build_param_list(j, beta0_1_train, beta0_2_train, sigma_y_train, sigma_u_1_train, sigma_u_2_train, scale_y_train, scale_u_1_train, scale_u_2_train)
...
save.image("C:/Users/qihan/Desktop/hom_W1_time/sim1_W1_time_test_10000.RData")
