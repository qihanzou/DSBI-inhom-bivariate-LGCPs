...
R_address = "C:/Users/qihan/Desktop/sim_inhom_S3"
setwd(R_address)
...
extract_one_case_features = function(params, image_nxy_set = NULL) {
  ...
  list(ok = TRUE, count_img = count_img)
}
...
stack_feature_results = function(res_list, response_par = NULL) {
  ...
  out = list(keep_true = keep_true, count_img = count_img)
...
save.image("C:/Users/qihan/Desktop/sim_inhom_S3/sim2_training_W1_S3.RData")
# ------------------------------------------------------------------------------
# Test
ntest = 5000
#set.seed(2025)
...
for (i in 1:n_runs) {
  ...
  model_path_i = sprintf("C:/Users/qihan/Desktop/sim_inhom_S3/W1_model_S3_run_%d.pth", i)
  model_hybrid = train_and_save_hybrid_NN_model(img_train_50, Y_train, model_path = model_path_i, batch_size = 100, epochs = 30, lr = 1e-3, requested_device = "auto", seed = seed_i, verbose = TRUE, standardize_img = TRUE)
  pred_par = load_hybrid_NN_model_predict(img_test_50, model_path_i, requested_device = "auto", predict_batch_size = predict_batch_size)^2
...
save.image("C:/Users/qihan/Desktop/sim_inhom_S3/sim2_W1_S3.RData")
