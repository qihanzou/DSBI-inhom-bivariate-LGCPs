...
save.image("C:/Users/qihan/Desktop/DSBI_bivariateLGCP/sim2_training_W1.RData")
# ------------------------------------------------------------------------------
# Test
ntest = 5000
#set.seed(2025)
...
for (i in 1:n_runs) {
  ...
  model_path_i = sprintf("C:/Users/qihan/Desktop/DSBI_bivariateLGCP/W1_model_50_run_%d.pth", i)
...
save.image("C:/Users/qihan/Desktop/DSBI_bivariateLGCP/sim2_W1.RData")
...
true_beta_full = cbind(beta0_1_test, beta0_2_test, beta1_1_test, beta1_2_test, beta2_1_test, beta2_2_test)
true_beta = true_beta_full[test_data$keep_true, , drop = FALSE]
true_beta = true_beta[test_data$keep_pcf, , drop = FALSE]
beta_ppm = test_data$beta_input
colnames(true_beta) = colnames(beta_ppm) = c("beta0_1", "beta0_2", "beta1_1", "beta1_2", "beta2_1", "beta2_2")


png(
  filename = "inhom_beta.png",
  width = 2400,
  height = 1800,
  res = 300
)
plot_beta_ppm(true_beta, beta_ppm)
dev.off()
...
par(mfrow = c(1, 3), mar = c(0.5, 0.5, 2.2, 0.5))
cols <- hcl.colors(100, rev = FALSE)
image((img_train[30,,,1]), col = cols, asp = 1, axes = FALSE, main = "Type 1")
image((img_train[30,,,2]), col = cols, asp = 1, axes = FALSE, main = "Type 2")
image((img_train[30,,,3]), col = cols, asp = 1, axes = FALSE, main = "Pooled")
